  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://images-its.chemistdirect.co.uk/Chemist-Direct-Zinc-15mg.jpg?o=O2pqbxqynEMEExqXbpEBNKkoFSgj&V=7N9z&w=800&h=800" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">Chemist Zinc 15mg</span>
          <span class="float-right text-gray-400">120 Tablets</span>
          <p class="text-lg font-bold">$ 250</p>
        </div>
      </div>
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://images-its.chemistdirect.co.uk/Chemist-Direct-Vitamin-E-400iu.jpg?o=4Tg8m@TRQRC6cyEEJADeZEGYC7Qj&V=WmFt&w=600&h=600" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">Vitamin E 400 iu</span>
          <span class="float-right text-gray-400">90 Tablets</span>
          <p class="mt-auto text-lg font-bold">$290</p>
        </div>
      </div>
    </div>
      ...
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
          ...
          <div class="ml-5">
            ...
            <p class="text-slate-500 text-sm leading-6">Express delivery: 1-3 Days</p>
          </div>
        </label>
      </div>
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
          ...
          <div class="ml-5">
            <span class="mt-2 font-semibold">flash delivery</span>
            <p class="text-slate-500 text-sm leading-6">Normal delivery: 3-5 days</p>
          </div>
        </label>
      </div>
    </form>
    ...
    <div class="">
      ...
      <div class="mt-6 border-t border-b py-2">
        <div class="flex items-center justify-between">
          ...
          <p class="font-semibold text-gray-900">$ 540</p>
        </div>
        <div class="flex items-center justify-between">
      ...
      <div class="mt-6 flex items-center justify-between">
        ...
        <p class="text-2xl font-semibold text-gray-900">$ 558</p>
      </div>
    </div>
    <Link to="/com">
    <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Payment</button>
    </Link>
  </div>
</div>
    </div>
